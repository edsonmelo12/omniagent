  ...
  <div class="carousel" id="carousel">
    <div class="wrapper" id="wrapper">
      ...
      <div class="slide" style="position:relative;width:calc(100%/7);height:100%;flex-shrink:0;overflow:hidden;background:{LIGHT_BG};">
        <div class="bg" style="filter:brightness(0.85) saturate(1.1);"></div>
...
## Export command
Use: node scripts/export-ac-30-06-v6.mjs
'''

info_path = PUBLISH_DIR / "export-info-v6.md"
