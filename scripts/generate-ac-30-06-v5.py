...
- instagram-carousel skill: base64 images, proper structure, export-ready 1080x1350
...
# ── Helper: progress bar ────────────────────────────────────────
def progress_bar(index: int, total: int = 7, is_light: bool = True) -> str:
...
def swipe_arrow(is_light: bool = True) -> str:
...
<div class="slide" style="position:relative;width:calc(100%/7);height:100%;flex-shrink:0;overflow:hidden;background:{LIGHT_BG};">
  <img src="{hero_data_uri}" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;z-index:0;filter:brightness(0.85) saturate(1.1);">
...
info_path = PUBLISH_DIR / "export-info.md"
