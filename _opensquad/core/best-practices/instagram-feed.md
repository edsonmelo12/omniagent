...
- The final caption and slide copy must be publishable text only. Do not surface internal labels, notes, or direction markers such as `Hook`, `CTA`, `autoridade de marca`, or `negocio premium`.
