...
- **Spacing**: **8px base unit** for 420px previews. All padding, gap and margin must be multiples of 8 (8, 16, 24, 32, 40, 48, 56, 64). No fractional or arbitrary values.
...
- [ ] **[multi-slide export]** All chrome elements (swipe arrows, progress bars, IG headers, dots, actions, captions) are hidden before screenshot capture — carousel HTML must include `.export-mode` CSS block
