...
- The visible post must not include drafting labels or notes. `Hook`, `CTA`, `autoridade de marca`, and `negocio premium` belong only in internal planning, not in the published text.
