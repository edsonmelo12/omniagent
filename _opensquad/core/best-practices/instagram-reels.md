...
- The on-screen text and caption must read like final publication copy. Keep `Hook`, `CTA`, `autoridade de marca`, and `negocio premium` out of the visible asset unless they are part of the actual spoken message.
