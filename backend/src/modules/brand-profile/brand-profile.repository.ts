...
export const listBrandProfilesByClientId = async (clientId: string) => {
  await ensureBrandProfileSchema();

  return query<BrandProfileRow>(
    `select
       id,
       client_id,
       source_snapshot_id,
...
export const findLatestBrandProfileByClientId = async (clientId: string) => {
  await ensureBrandProfileSchema();

  return queryOne<BrandProfileRow>(
    `select
       id,
       client_id,
       source_snapshot_id,
...
export const createBrandProfileVersion = async (input: {
  clientId: string;
  ...
  withTransaction(async (client) => {
    ...
    const result = await client.query<BrandProfileRow>(
...
export const updateBrandProfileVersion = async (input: {
  clientId: string;
  sourceSnapshotId?: string | null;
  sourceClientRecordId?: string | null;
  sourceMarketResearchId?: string | null;
