...
import {
  getStrategyIntelligenceByAssetId,
  listStrategyIntelligenceForClient,
  persistStrategyIntelligenceFromYoutubeAnalysis,
  recommendStrategyForClient,
} from "./strategy-intelligence.service.js";
...
export const registerStrategyIntelligenceRoutes = (app: FastifyInstance) => {
