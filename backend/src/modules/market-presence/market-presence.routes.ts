...
import {
  marketPresenceBaselineCreateSchema,
  marketPresenceCheckpointCreateSchema,
  marketPresenceCompareSchema,
  marketPresenceInterventionCreateSchema,
} from "./market-presence.schemas.js";
import {
  compareMarketPresence,
  createMarketPresenceBaseline,
  createMarketPresenceCheckpoint,
  createMarketPresenceInterventionRecord,
  getMarketPresenceContext,
} from "./market-presence.service.js";
...
export const registerMarketPresenceRoutes = (app: FastifyInstance) => {
