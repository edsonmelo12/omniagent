...
import { REMOTION_COMPOSITION_ID, REMOTION_DURATION_IN_FRAMES, REMOTION_FPS, REMOTION_HEIGHT, REMOTION_WIDTH, } from "./remotion-root.js";
...
const buildSrtFromNarration = (input) => {
    const sceneOffsets = { hero: 0, lead: 72, support: 156, close: 202 };
    const lines = [
...
const createAmbientSoundtrack = async (input) => {
    ...
    for (let i = 0; i < sampleCount; i += 1) {
        ...
        const tone = chord.reduce((sum, freq, index) => {
