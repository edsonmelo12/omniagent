# Creative Rules - Client-Agnostic

## Purpose

Este arquivo define as regras visuais e editoriais que a skill deve obedecer ao planejar artes para qualquer cliente cadastrado.
...
- reforça a identidade do cliente
